...
STAGE 1: CONTACTED
   ...
   Initial campaign outreach via cellular and telephone.
    ↓
   ...
   Leads who interacted with the campaign.
    ↓
   ...
   Successful account openings/sales.
...
This project demonstrates how data can be used to optimize marketing funnels and improve business decision-making.
